...
CREATE TABLE IF NOT EXISTS `branchcoms` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_branchcoms_on_company_id` (`company_id`),
  KEY `index_branchcoms_on_branch_id` (`branch_id`)
...
-- Dumping data for table hris.schema_migrations: ~8 rows (approximately)
